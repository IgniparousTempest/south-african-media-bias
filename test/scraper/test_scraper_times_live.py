...
class MyTestCase(unittest.TestCase):
    def test_is_in_domain(self):
        ...
        self.assertFalse(spider.is_in_domain('/product-reviews/B07VRMVT3N/ref=pd_cp_309_cr_4/136-9194889-5780825?ie=UTF8&pd_rd_i=B07VRMVT3N&pd_rd_r=25c3884b-daf8-4005-b0fd-397b93885049&pd_rd_w=Ml7MV&pd_rd_wg=jWHX5&pf_rd_p=0e5324e1-c848-4872-bbd5-5be6baedf80e&pf_rd_r=YNZQR1W5S2M41TZ978HQ&refRID=YNZQR1W5S2M41TZ978HQ', 'https://www.amazon.com/'))
        ...
        self.assertTrue(spider.is_in_domain('/politics/2019-11-23-ramaphosa-defends-eskom-ceo-appointment/', 'https://www.timeslive.co.za/'))
